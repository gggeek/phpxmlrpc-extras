## XML-RPC for PHP EXTRAS version 1.0.1 - 2025/11/11
...
- improved: separated the demo files into their own tarball
...
- improved: made it easy to add custom css and favicon to the docs generated by `SelfDocumentingServer`. See the
  file `docServer.php` for an example
