...
class SelfDocumentingJsonRpcServerTest extends ExtrasWebTestCase
{
    protected $defaultTarget = '?demo=server/docServerJsonRpc.php';
    ...
    {
        $response = $this->call('examples.addtwo', array(6, 7), false, true);
