...
/**
 * @todo if we fronted the json-rpc server instead of subclassing it, we might be able to easily use all this magic
 *       with both xml-rpc and json-rpc protocols in one class...
 */
class JSRpcServer extends Server
{
    ...
    function __construct($dispatchMap = null, $serviceNow = true)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SERVER['CONTENT_TYPE']) &&
            ...
            // xml-rpc call received: serve web service
